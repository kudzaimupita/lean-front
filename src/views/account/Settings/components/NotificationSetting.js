  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="hidden sm:block ltr:ml-2 rtl:mr-2">Delete</span>
      </Segment.Item>
      <Segment.Item
        className="flex items-center justify-center"
        type="button"
        value="browser"
      >
        <HiGlobeAlt className="text-xl text-red" />
        <span className="hidden sm:block  ltr:ml-2 rtl:mr-2">View</span>
      </Segment.Item>
      <Segment.Item
        className="flex items-center justify-center"
        type="button"
      ...
      >
        ...
        <span className="hidden sm:block  ltr:ml-2 rtl:mr-2">List </span>
      </Segment.Item>
      <Segment.Item
        className="flex items-center justify-center"
        type="button"
      ...
      >
        ...
        <span className="hidden sm:block  ltr:ml-2 rtl:mr-2">Update</span>
      </Segment.Item>
      <Segment.Item
        className="flex items-center justify-center"
        type="button"
      ...
      >
        <HiOutlineDeviceMobile className="text-xl" />
        <span className="hidden sm:block  ltr:ml-2 rtl:mr-2">Create</span>
      </Segment.Item>
      <Segment.Item
        className="flex items-center justify-center"
        type="button"
